...
public class CreatePageWithContentFragment implements WorkflowProcess {
    ...
    public void execute(WorkItem item, WorkflowSession session, MetaDataMap map) throws WorkflowException {
        ...
        try {
            ...
            createPageWithCF(resourceResolver, pagelocation, pageTitle, payloadPath);
    ...
    private void createPageWithCF(ResourceResolver resourceResolver, String pageLocation, String pageTitle, String payloadPath) {
        ...
        try {
            ...
            String pageName = com.day.cq.commons.jcr.JcrUtil.createValidName(pageTitle);
